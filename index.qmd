...
Additionally, note that in @tbl-horse-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse.

![Horse populations for the province with the largest standard deviation.](results/horse_pops_plot_largest_sd.png){#fig-horse-pop-elev width=60%}

In @fig-horse-pop-elev we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
